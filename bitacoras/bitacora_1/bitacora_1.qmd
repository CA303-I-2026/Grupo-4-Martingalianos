...
tabla <- data.frame(
  ...
  "Demás caracteres (Números)" = c("", "00-09","00","001","002","009","00-09","00","001","04"),
  "Enfermedad" = c(
...
kable(
  tabla,
  caption = "Tabla 1. Ejemplo breve de la clasificación de enfermedades de acuerdo al ICD-10. Elaboración propia"
)
```